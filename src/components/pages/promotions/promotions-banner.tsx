      ...
      <div className="mx-auto grid max-w-[1180px] grid-cols-1 items-center gap-14 px-10 md:grid-cols-[1.05fr_1fr]">
        ...
        <div>
          ...
          <p className="mb-[30px] max-w-[460px] text-[15px] leading-[1.7] text-dr-text-2">
            Discover unbeatable deals on cutting-edge drones. Elevate your
            aerial adventures with promotions built for pilots at every level.
          </p>

          <div className="flex flex-wrap items-center gap-5">
            <Link
              href="#promotions-grid"
            ...
            <span className="max-w-[200px] text-[12.5px] leading-[1.5] text-dr-text-3">
              New drops every season &mdash; codes at checkout
            </span>
          </div>
        </div>

        {/* Right - drone panel */}
        <div className="relative aspect-[4/3] overflow-hidden rounded-[18px] border border-dr-red/20 bg-[radial-gradient(circle_at_50%_45%,rgba(239,43,69,0.16),transparent_60%)]">
          <Image
            src="/assets/drone-d3.png"
            alt="Featured drone on sale"
            fill
            priority
